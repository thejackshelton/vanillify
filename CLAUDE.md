...
**Core Value:** Accurate, reliable conversion of Tailwind classes to vanilla CSS — powered by UnoCSS's `createGenerator` which gives us the actual CSS rather than guessing at it.
